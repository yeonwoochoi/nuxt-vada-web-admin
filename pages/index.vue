    ...
    <v-row align="start" justify="start">
          ...
          <template v-slot:default>
            ...
            >
              <template v-slot:item.title="{item}">
                <td class="text-start ellipsis" style="cursor: pointer; max-width: 280px; font-size: 13px;">
      ...
      <v-col cols="12" md="6" class="my-2 pr-md-5">
        <dashboard-card :title="salesTitle" :link="salesLink">
          <template v-slot:default>
            <line-chart :chart-data="salesItems" ref="salesChartRef"/>
          </template>
        </dashboard-card>
      </v-col>
      <v-col cols="12" md="6" class="my-2 pl-md-5">
        <dashboard-card :title="userTitle" :link="userLink">
          <template v-slot:default>
            <line-chart :chart-data="userCountItems" ref="userCountChartRef"/>
          </template>
        </dashboard-card>
      </v-col>
      ...
      <v-col cols="12" md="7" class="my-2 pl-md-5">
        <dashboard-card :title="newsTitle" :link="newsLink">
          <template v-slot:default>
            ...
            >
              <template v-slot:item.title="{item}">
                <td class="text-start ellipsis" style="cursor: pointer; max-width: 130px; font-size: 13px;">
                  <div class="ellipsis font-weight-medium">
                    {{ item.title }}
                  </div>
                </td>
...
export default {
  ...
  data: () => ({
    ...
    salesItems: [80, 120, 105, 110, 95, 105, 90, 100, 80, 95, 70, 120],
    userCountItems: [80, 120, 105, 110, 95, 105, 90, 100, 80, 95, 70, 120],
    dataUpdateItems: [
      {
  ...
  methods: {
    ...
    moveInquiryDetail({index}) {
      this.$router.push(this.inquiryLink + `/${index}`)
    },
    moveNewsDetail({idx}) {
  ...
  mounted() {
    this.$refs.salesChartRef.initBigChart(0);
    this.$refs.userCountChartRef.initBigChart(0);
  }
}
</script>
